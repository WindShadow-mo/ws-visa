...
const zhCharMap: Record<string, string> = {
  ...
  '巴': 'B', '白': 'B', '保': 'B', '北': 'B', '贝': 'B', '比': 'B', '玻': 'B', '不': 'B', '布': 'B', '波': 'B', '伯': 'B', '博': 'B', '冰': 'B', '百': 'B',
  '查': 'C', '朝': 'C', '赤': 'C',
  '丹': 'D', '德': 'D', '第': 'D', '多': 'D', '东': 'D', '厄': 'E', '俄': 'E',
  '发': 'F', '法': 'F', '芬': 'F', '佛': 'F', '斐': 'F', '菲': 'F', '梵': 'F', '福': 'F',
  '冈': 'G', '刚': 'G', '哥': 'G', '格': 'G', '古': 'G', '瓜': 'G', '圭': 'G', '关': 'G',
  '哈': 'H', '海': 'H', '韩': 'H', '荷': 'H', '黑': 'H', '洪': 'H',
  '吉': 'J', '加': 'J', '柬': 'J', '几': 'J', '捷': 'J', '津': 'J', '基': 'J',
  '喀': 'K', '科': 'K', '肯': 'K', '克': 'K', '库': 'K', '卡': 'K', '开': 'K',
  '拉': 'L', '莱': 'L', '老': 'L', '黎': 'L', '立': 'L', '利': 'L', '列': 'L', '卢': 'L', '罗': 'L', '留': 'L', '联': 'L',
  '马': 'M', '毛': 'M', '美': 'M', '蒙': 'M', '孟': 'M', '秘': 'M', '摩': 'M', '莫': 'M', '墨': 'M', '缅': 'M', '密': 'M',
  '纳': 'N', '南': 'N', '尼': 'N', '鸟': 'N', '挪': 'N', '瑙': 'N', '纽': 'N', '诺': 'N',
  '欧': 'O',
  '帕': 'P', '培': 'P', '佩': 'P', '批': 'P', '皮': 'P', '婆': 'P', '葡': 'P',
  '其': 'Q', '千': 'Q', '前': 'Q', '强': 'Q', '琴': 'Q', '青': 'Q', '庆': 'Q', '秋': 'Q', '丘': 'Q', '曲': 'Q', '全': 'Q', '权': 'Q',
  '日': 'R', '瑞': 'R',
  '萨': 'S', '塞': 'S', '三': 'S', '桑': 'S', '沙': 'S', '山': 'S', '上': 'S', '圣': 'S', '斯': 'S', '苏': 'S', '所': 'S', '索': 'S',
  '塔': 'T', '泰': 'T', '坦': 'T', '汤': 'T', '特': 'T', '突': 'T', '土': 'T', '图': 'T', '脱': 'T', '托': 'T',
  '瓦': 'W', '外': 'W', '危': 'W', '委': 'W', '乌': 'W', '文': 'W', '无': 'W', '威': 'W',
  '西': 'X', '希': 'X', '新': 'X', '匈': 'X', '叙': 'X', '香': 'X', '耶': 'Y',
...
<template>
  <FormFieldWrapper :label="label" :html-for="name" :required="required" :span="span" :field-name="name">
